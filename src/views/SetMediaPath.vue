<template>
  <main class="flex flex-col sm:flex-col md:flex-row justify-center items-center h-screen w-full p-16 space-x-0 sm:space-x-0 md:space-x-16 space-y-16 sm:space-y-16 md:space-y-0">
